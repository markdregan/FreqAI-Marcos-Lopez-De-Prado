...
class LitmusStrategy(IStrategy):
    """
    ...
    buy_adx_min = DecimalParameter(20,
                                   40,
                                   decimals=1,
                                   default=30.1,
                                   space="buy")
    buy_adx_max = DecimalParameter(20,
                                   40,
                                   decimals=1,
                                   default=30.1,
                                   space="buy")
    sell_adx_enabled = BooleanParameter(default=True, space="sell")
    sell_adx_min = DecimalParameter(20,
                                    40,
                                    decimals=1,
                                    default=30.1,
                                    space="sell")
    sell_adx_max = DecimalParameter(20,
                                    40,
                                    decimals=1,
                                    default=30.1,
                                    space="sell")
    ...
    buy_rsi_max = IntParameter(20, 40, default=30, space="buy")
    sell_rsi_enabled = CategoricalParameter([True, False],
                                            default=False,
                                            space="sell")
    sell_rsi_min = IntParameter(20, 40, default=30, space="sell")
    sell_rsi_max = IntParameter(20, 40, default=30, space="sell")
    ...
    # Protections
    cooldown_lookback = IntParameter(2,
                                     48,
                                     default=5,
                                     space="protection",
                                     optimize=True)
    stop_duration = IntParameter(12,
                                 200,
                                 default=5,
                                 space="protection",
                                 optimize=True)
    use_stop_protection = BooleanParameter(default=True,
                                           space="protection",
                                           optimize=True)
    ...
    def populate_buy_trend(self, dataframe: DataFrame,
        ...
        if self.buy_adx_enabled.value:
            ...
            conditions.append(dataframe['adx'] < self.buy_adx_max.value)
    ...
    def populate_sell_trend(self, dataframe: DataFrame,
        ...
        if self.sell_adx_enabled.value:
            conditions.append(dataframe['adx'] > self.sell_adx_min.value)
            conditions.append(dataframe['adx'] < self.sell_adx_max.value)

        # RSI
        if self.sell_rsi_enabled.value:
            conditions.append(dataframe['rsi'] > self.sell_rsi_min.value)
            conditions.append(dataframe['rsi'] < self.sell_rsi_max.value)
